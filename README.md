...
- タスク、予定、アイデア、待ち、決定、プロジェクト、アニメ、マンガの保存
- タスク名だけの単独入力からの、合言葉不要・即時1件タスク追加（期限・所属プロジェクト・ステータスの自動補完）
- プロジェクト、アニメ・マンガ、今日、進行中、次にやる、待ち、いつか、完了、確認待ち、更新履歴、すべての画面
- アニメの配信日・配信スケジュールとマンガの発売日の管理
...
最小化または右上の「×」でタスクトレイに収まり、トレイアイコンのダブルクリックで再表示できます。完全に終了する場合は、画面上部の「更新」右隣、またはトレイアイコンの右クリックメニューから「終了」を選びます。
...
4. アプリの「今日」「進行中」「次にやる」「確認待ち」「更新履歴」などで結果を確認する。
